...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    name="pack_size"
                    type="text"
                    value="<?php echo e(old('pack_size')); ?>"
                    class="w-full border border-gray-300 p-2 rounded"
                    placeholder="e.g. 237ml, 1 LITER, 1.5 LTR x 12"
                    
                >
                <?php $__errorArgs = ['pack_size'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <tr>
                                ...
                                <td class="border px-2 py-1">
                                    <input
                                        ...
                                        min="0"
                                        step="1"
                                        value="<?php echo e(old('bottles_per_case')); ?>"
                                        class="w-full border border-gray-300 p-2 rounded text-right"
                                        placeholder="e.g. 24"
                                    >
                                </td>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\sales-report\resources\views\admin\products\create.blade.php ENDPATH**/ ?>