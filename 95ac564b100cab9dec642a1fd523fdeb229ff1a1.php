...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="text-2xl font-semibold text-facebookBlue">ðŸ–Šï¸ Edit Division</h2>
     <?php $__env->endSlot(); ?>
            ...
            <div class="mb-4">
                ...
                <select name="business_line_id" id="business_line_id" required class="w-full border border-gray-300 p-2 rounded">
                    ...
                    <?php $__currentLoopData = $businessLines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($line->id); ?>"
                            <?php echo e((old('business_line_id', $division->business_line_id) == $line->id) ? 'selected' : ''); ?>>
            ...
            <?php $__currentLoopData = [
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="<?php echo e($field); ?>"
                        value="<?php echo e(old($field, $division->$field)); ?>"
...
<?php /**PATH C:\xampp\htdocs\sales-report\resources\views\admin\divisions\edit.blade.php ENDPATH**/ ?>