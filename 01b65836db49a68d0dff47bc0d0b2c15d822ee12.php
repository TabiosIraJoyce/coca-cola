...
<script>
let columns = <?php echo json_encode($columns ?? $defaultColumns ?? ['Column 1'], 15, 512) ?>;
let rows    = <?php echo json_encode($rows ?? $defaultRows ?? [['']], 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\sales-report\resources\views\admin\consolidated\partials\dynamic-table.blade.php ENDPATH**/ ?>